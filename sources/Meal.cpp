/**
 *  Meal.cpp - libobjs Class Implementation - This class is
 *             responsible for defining a meal and its ingredients.
 *
 ...
 *
 *  Domain Rules:
 *  - Meal output preserves ingredient ordering as stored in the vector.
 */
